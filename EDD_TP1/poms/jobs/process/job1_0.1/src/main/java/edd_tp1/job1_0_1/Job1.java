...
/**
 * Job: Job1 Purpose: Generation de 100 lignes<br>
 * Description: Créer un Job qui génère 100 lignes de données avec: - ID - Nom -
 * Prénom - Ville - DT_Naissance Afficher ces données dans la console de Talend
...
public class Job1 implements TalendJob {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_EDD_TP1_Job1 = new byte[0];
		static byte[] commonByteArray_EDD_TP1_Job1 = new byte[0];
		...
		public java.util.Date DT_Naissance;

		public java.util.Date getDT_Naissance() {
			return this.DT_Naissance;
		}

		public Boolean DT_NaissanceIsNullable() {
			return true;
		}

		public Boolean DT_NaissanceIsKey() {
			return false;
		}

		public Integer DT_NaissanceLength() {
			return null;
		}

		public Integer DT_NaissancePrecision() {
			return null;
		}

		public String DT_NaissanceDefault() {

			return "";

		}

		public String DT_NaissanceComment() {

			return "";

		}

		public String DT_NaissancePattern() {

			return "dd-MM-yyyy";

		}

		public String DT_NaissanceOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_TP1_Job1.length) {
					if (length < 1024 && commonByteArray_EDD_TP1_Job1.length == 0) {
						commonByteArray_EDD_TP1_Job1 = new byte[1024];
					} else {
						commonByteArray_EDD_TP1_Job1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_TP1_Job1, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_Job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EDD_TP1_Job1, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_Job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_TP1_Job1) {
				...
				try {
					...
					this.DT_Naissance = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.DT_Naissance, dos);
		...
		public String toString() {
			...
			sb.append(",DT_Naissance=" + String.valueOf(DT_Naissance));
			sb.append("]");
		...
		public String toLogString() {
			...
			if (DT_Naissance == null) {
				sb.append("<null>");
			} else {
				sb.append(DT_Naissance);
			}
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "ID", "Nom", "Prenom", "Ville", "DT_Naissance", });
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					...
					public java.util.Date getRandomDT_Naissance() {

						return TalendDate.getRandomDate("1995-01-01", "2005-12-31");
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					row1.DT_Naissance = randtRowGenerator_1.getRandomDT_Naissance();
...
///////////////////////		
					...
					if (row1.Nom != null) { //
						row_tLogRow_1[1] = String.valueOf(row1.Nom);

					} //

					if (row1.Prenom != null) { //
						row_tLogRow_1[2] = String.valueOf(row1.Prenom);

					} //

					if (row1.Ville != null) { //
						row_tLogRow_1[3] = String.valueOf(row1.Ville);

					} //

					if (row1.DT_Naissance != null) { //
						row_tLogRow_1[4] = FormatterUtils.format_Date(row1.DT_Naissance, "dd-MM-yyyy");
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_pTRiUJiYEfCFNoXI1bVdwg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-10-01T08:31:31.016802300Z");
		...
		try {
			...
			java.io.InputStream inContext = Job1.class.getClassLoader()
					.getResourceAsStream("edd_tp1/job1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 77437 characters generated by Talend Cloud API Services Platform on the 1
 * octobre 2025 à 10:31:31 CEST
 ************************************************************************************************/