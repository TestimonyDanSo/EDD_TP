...
package edd_tp1.jreadfilecustomertd_0_1;
...
/**
 * Job: jReadFileCustomerTD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jReadFileCustomerTD implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "jReadFileCustomerTD.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(jReadFileCustomerTD.class);
	...
	private final String jobName = "jReadFileCustomerTD";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				jReadFileCustomerTD.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jReadFileCustomerTD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_EDD_TP1_jReadFileCustomerTD = new byte[0];
		static byte[] commonByteArray_EDD_TP1_jReadFileCustomerTD = new byte[0];
		...
		public Boolean ADRESSIsNullable() {
			return true;
		}

		public Boolean ADRESSIsKey() {
			return false;
		}

		public Integer ADRESSLength() {
			return 200;
		}

		public Integer ADRESSPrecision() {
			return null;
		}

		public String ADRESSDefault() {

			return null;

		}

		public String ADRESSComment() {

			return "";

		}

		public String ADRESSPattern() {

			return "";

		}

		public String ADRESSOriginalDbColumnName() {
		...
		public Boolean CODE_TYPEIsNullable() {
			return false;
		}

		public Boolean CODE_TYPEIsKey() {
			return false;
		}

		public Integer CODE_TYPELength() {
			return 50;
		}

		public Integer CODE_TYPEPrecision() {
			return null;
		}

		public String CODE_TYPEDefault() {

			return null;

		}

		public String CODE_TYPEComment() {

			return "";

		}

		public String CODE_TYPEPattern() {

			return "";

		}

		public String CODE_TYPEOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_TP1_jReadFileCustomerTD.length) {
					if (length < 1024 && commonByteArray_EDD_TP1_jReadFileCustomerTD.length == 0) {
						commonByteArray_EDD_TP1_jReadFileCustomerTD = new byte[1024];
					} else {
						commonByteArray_EDD_TP1_jReadFileCustomerTD = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_TP1_jReadFileCustomerTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileCustomerTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EDD_TP1_jReadFileCustomerTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileCustomerTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_TP1_jReadFileCustomerTD) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "5udvb0_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "CUSTOMER", "tSnowflakeOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				props_tDBOutput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Nw4PGKTm/5tP6nyRMKJ4scBiDJkVLsSQgx8VjcmXkYiY5NdWp+Srb/QAeQ=="));

				props_tDBOutput_1.connection.referencedComponent.setValue("referenceDefinitionName",
						"tSnowflakeConnection");

				props_tDBOutput_1.table.setValue("tableName", "CUSTOMER");
				...
				props_tDBOutput_1.table.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:7YOjYdGnphUnfQFbc1kamx7P6QyN0ewa/UCjx/04Q5cZwtE9gJ0vdP3rqA=="));
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"CUSTOMER\",\"fields\":[{", s);

						a("\"name\":\"CUSTOMER_ID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CUSTOMER_ID\",\"talend.field.dbColumnName\":\"CUSTOMER_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CUSTOMER_ID\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"LAST_NAME\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"LAST_NAME\",\"talend.field.dbColumnName\":\"LAST_NAME\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"LAST_NAME\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"FIRST_NAME\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"FIRST_NAME\",\"talend.field.dbColumnName\":\"FIRST_NAME\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"FIRST_NAME\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"ADRESS\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ADRESS\",\"talend.field.dbColumnName\":\"ADRESS\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"200\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ADRESS\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"POSTAL_CODE\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"POSTAL_CODE\",\"talend.field.dbColumnName\":\"POSTAL_CODE\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"POSTAL_CODE\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"CITY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CITY\",\"talend.field.dbColumnName\":\"CITY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CITY\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"COUNTRY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"COUNTRY\",\"talend.field.dbColumnName\":\"COUNTRY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"COUNTRY\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"CODE_TYPE\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CODE_TYPE\",\"talend.field.dbColumnName\":\"CODE_TYPE\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CODE_TYPE\",\"di.column.relatedEntity\":\"\"}],\"di.table.comment\":\"\",\"di.table.name\":\"CUSTOMER\",\"di.table.label\":\"CUSTOMER\"}",
								s);
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append(
									"FILENAME" + " = " + "\"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CUSTOMER.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									...
									+ ", SCHEMA_COLUMN=" + ("LAST_NAME") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("FIRST_NAME") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("ADRESS")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("POSTAL_CODE") + "}, {TRIM="
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CUSTOMER.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CUSTOMER.csv", "ISO-8859-15", "|", "\n", true,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.CUSTOMER_ID = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.CODE_TYPE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
							...
							if (row1.CUSTOMER_ID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.CUSTOMER_ID));
							...
							if (row1.LAST_NAME != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.LAST_NAME));
							...
							if (row1.FIRST_NAME != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.FIRST_NAME));
							...
							if (row1.ADRESS != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.ADRESS));
							...
							if (row1.POSTAL_CODE != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.POSTAL_CODE));
							...
							if (row1.CODE_TYPE != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.CODE_TYPE));
...
///////////////////////    			
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "CUSTOMER",
									"tSnowflakeOutput"
							...
							if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema()
								...
								incomingEnforcer_tDBOutput_1.put("CUSTOMER_ID", row2.CUSTOMER_ID);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("LAST_NAME") != null) {
								incomingEnforcer_tDBOutput_1.put("LAST_NAME", row2.LAST_NAME);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("FIRST_NAME") != null) {
								incomingEnforcer_tDBOutput_1.put("FIRST_NAME", row2.FIRST_NAME);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("ADRESS") != null) {
								incomingEnforcer_tDBOutput_1.put("ADRESS", row2.ADRESS);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema()
									.getField("POSTAL_CODE") != null) {
								incomingEnforcer_tDBOutput_1.put("POSTAL_CODE", row2.POSTAL_CODE);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
							...
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("CODE_TYPE") != null) {
								incomingEnforcer_tDBOutput_1.put("CODE_TYPE", row2.CODE_TYPE);
							}
					...
					if (!((Object) ("C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CUSTOMER.csv") instanceof java.io.InputStream)) {
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "CUSTOMER", "tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
	...
	public static void main(String[] args) {
		final jReadFileCustomerTD jReadFileCustomerTDClass = new jReadFileCustomerTD();

		int exitCode = jReadFileCustomerTDClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'jReadFileCustomerTD' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'jReadFileCustomerTD' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_OUofAKN3EfCCd7k3d2fHCg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-10-07T12:21:39.063098800Z");
		...
		try {
			...
			java.io.InputStream inContext = jReadFileCustomerTD.class.getClassLoader()
					.getResourceAsStream("edd_tp1/jreadfilecustomertd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jReadFileCustomerTD.class.getClassLoader()
		...
		log.info("TalendJob: 'jReadFileCustomerTD' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : jReadFileCustomerTD");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'jReadFileCustomerTD' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 129619 characters generated by Talend Cloud API Services Platform on the 7
 * octobre 2025 à 14:21:39 CEST
 ************************************************************************************************/