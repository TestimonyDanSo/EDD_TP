...
package edd_tp1.jreadfilesubcategorytd_0_1;
...
/**
 * Job: jReadFileSubCategoryTD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jReadFileSubCategoryTD implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "jReadFileSubCategoryTD.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(jReadFileSubCategoryTD.class);
	...
	private final String jobName = "jReadFileSubCategoryTD";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				jReadFileSubCategoryTD.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jReadFileSubCategoryTD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_EDD_TP1_jReadFileSubCategoryTD = new byte[0];
		static byte[] commonByteArray_EDD_TP1_jReadFileSubCategoryTD = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_EDD_TP1_jReadFileSubCategoryTD) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String DESCRIPTION_SUBCATEGORY;

		public String getDESCRIPTION_SUBCATEGORY() {
			return this.DESCRIPTION_SUBCATEGORY;
		}

		public Boolean DESCRIPTION_SUBCATEGORYIsNullable() {
			return false;
		}

		public Boolean DESCRIPTION_SUBCATEGORYIsKey() {
			return false;
		}

		public Integer DESCRIPTION_SUBCATEGORYLength() {
			return 100;
		}

		public Integer DESCRIPTION_SUBCATEGORYPrecision() {
			return null;
		}

		public String DESCRIPTION_SUBCATEGORYDefault() {

			return null;

		}

		public String DESCRIPTION_SUBCATEGORYComment() {

			return "";

		}

		public String DESCRIPTION_SUBCATEGORYPattern() {

			return "";

		}

		public String DESCRIPTION_SUBCATEGORYOriginalDbColumnName() {

			return "DESCRIPTION_SUBCATEGORY";
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_TP1_jReadFileSubCategoryTD.length) {
					if (length < 1024 && commonByteArray_EDD_TP1_jReadFileSubCategoryTD.length == 0) {
						commonByteArray_EDD_TP1_jReadFileSubCategoryTD = new byte[1024];
					} else {
						commonByteArray_EDD_TP1_jReadFileSubCategoryTD = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_TP1_jReadFileSubCategoryTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileSubCategoryTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EDD_TP1_jReadFileSubCategoryTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileSubCategoryTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_TP1_jReadFileSubCategoryTD) {
				...
				try {
					...
					this.DESCRIPTION_SUBCATEGORY = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.DESCRIPTION_SUBCATEGORY, dos);
		...
		public String toString() {
			...
			sb.append(",DESCRIPTION_SUBCATEGORY=" + DESCRIPTION_SUBCATEGORY);
		...
		public String toLogString() {
			...
			if (DESCRIPTION_SUBCATEGORY == null) {
				sb.append("<null>");
			} else {
				sb.append(DESCRIPTION_SUBCATEGORY);
			}
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "E6kxqU_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "SUBCATEGORY_PRODUCT", "tSnowflakeOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				props_tDBOutput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:6GB3wnPIOm9sKnIEbNT4AMWUfX/0b87Y1mSXu5LysPxXna+edfrqu2JFpg=="));

				props_tDBOutput_1.connection.referencedComponent.setValue("referenceDefinitionName",
						"tSnowflakeConnection");

				props_tDBOutput_1.table.setValue("tableName", "SUBCATEGORY_PRODUCT");
				...
				props_tDBOutput_1.table.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:d8kg4Gkisr1rW+j4U1sLKntsxixnryANt27zUQowG9xJkOkywWLKeUMbvg=="));
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"SUBCATEGORY_PRODUCT\",\"fields\":[{", s);

						a("\"name\":\"CODE_SUBCATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CODE_SUBCATEGORY\",\"talend.field.dbColumnName\":\"CODE_SUBCATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CODE_SUBCATEGORY\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"DESCRIPTION_SUBCATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DESCRIPTION_SUBCATEGORY\",\"talend.field.dbColumnName\":\"DESCRIPTION_SUBCATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"DESCRIPTION_SUBCATEGORY\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"CODE_CATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CODE_CATEGORY\",\"talend.field.dbColumnName\":\"CODE_CATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CODE_CATEGORY\",\"di.column.relatedEntity\":\"\"}],\"di.table.comment\":\"\",\"di.table.name\":\"SUBCATEGORY_PRODUCT\",\"di.table.label\":\"SUBCATEGORY_PRODUCT\"}",
								s);
...
///////////////////////    			
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = "
									+ "\"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SUB_CATEGORY.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("CODE_SUBCATEGORY") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("DESCRIPTION_SUBCATEGORY") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("CODE_CATEGORY") + "}]");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SUB_CATEGORY.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SUB_CATEGORY.csv", "UTF-8", "|", "\n", true, 1,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.DESCRIPTION_SUBCATEGORY = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.CODE_CATEGORY = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////    			
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "SUBCATEGORY_PRODUCT",
									"tSnowflakeOutput"
					...
					if (!((Object) ("C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SUB_CATEGORY.csv") instanceof java.io.InputStream)) {
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "SUBCATEGORY_PRODUCT", "tSnowflakeOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
	...
	public static void main(String[] args) {
		final jReadFileSubCategoryTD jReadFileSubCategoryTDClass = new jReadFileSubCategoryTD();

		int exitCode = jReadFileSubCategoryTDClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'jReadFileSubCategoryTD' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'jReadFileSubCategoryTD' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_VyHZsKN2EfCCd7k3d2fHCg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-10-07T12:37:20.860319200Z");
		...
		try {
			...
			java.io.InputStream inContext = jReadFileSubCategoryTD.class.getClassLoader()
					.getResourceAsStream("edd_tp1/jreadfilesubcategorytd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jReadFileSubCategoryTD.class.getClassLoader()
		...
		log.info("TalendJob: 'jReadFileSubCategoryTD' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : jReadFileSubCategoryTD");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'jReadFileSubCategoryTD' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 104409 characters generated by Talend Cloud API Services Platform on the 7
 * octobre 2025 à 14:37:20 CEST
 ************************************************************************************************/