...
package edd_tp1.jreadfilesaletd_0_1;
...
/**
 * Job: jReadFileSaleTD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jReadFileSaleTD implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "jReadFileSaleTD.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(jReadFileSaleTD.class);
	...
	private final String jobName = "jReadFileSaleTD";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				jReadFileSaleTD.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jReadFileSaleTD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_EDD_TP1_jReadFileSaleTD = new byte[0];
		static byte[] commonByteArray_EDD_TP1_jReadFileSaleTD = new byte[0];
		...
		public Boolean SALE_IDIsNullable() {
			return false;
		}

		public Boolean SALE_IDIsKey() {
			return false;
		}

		public Integer SALE_IDLength() {
			return 50;
		}

		public Integer SALE_IDPrecision() {
			return null;
		}

		public String SALE_IDDefault() {

			return null;

		}

		public String SALE_IDComment() {

			return "";

		}

		public String SALE_IDPattern() {

			return "";

		}

		public String SALE_IDOriginalDbColumnName() {

			return "SALE_ID";

		}

		public java.util.Date DATE_SALE;

		public java.util.Date getDATE_SALE() {
			return this.DATE_SALE;
		}

		public Boolean DATE_SALEIsNullable() {
			return false;
		}

		public Boolean DATE_SALEIsKey() {
			return false;
		}

		public Integer DATE_SALELength() {
			return null;
		}

		public Integer DATE_SALEPrecision() {
			return null;
		}

		public String DATE_SALEDefault() {

			return null;

		}

		public String DATE_SALEComment() {

			return "";

		}

		public String DATE_SALEPattern() {

			return "yyyy-MM-dd'T'HH:mm:ss";

		}

		public String DATE_SALEOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_TP1_jReadFileSaleTD.length) {
					if (length < 1024 && commonByteArray_EDD_TP1_jReadFileSaleTD.length == 0) {
						commonByteArray_EDD_TP1_jReadFileSaleTD = new byte[1024];
					} else {
						commonByteArray_EDD_TP1_jReadFileSaleTD = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_TP1_jReadFileSaleTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileSaleTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EDD_TP1_jReadFileSaleTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileSaleTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_TP1_jReadFileSaleTD) {

				try {

					int length = 0;

					this.SALE_ID = readString(dis);

					this.DATE_SALE = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.SALE_ID, dos);

				// java.util.Date

				writeDate(this.DATE_SALE, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("SALE_ID=" + SALE_ID);
			sb.append(",DATE_SALE=" + String.valueOf(DATE_SALE));
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "WDp7Hd_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "SALE", "tSnowflakeOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				props_tDBOutput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:8bO8e50g9u7EFjA2v6CUbOSWn76lnWIPQ2adobIlQ5NJZBjqZaTvd/OWSw=="));

				props_tDBOutput_1.connection.referencedComponent.setValue("referenceDefinitionName",
						"tSnowflakeConnection");

				props_tDBOutput_1.table.setValue("tableName", "SALE");
				...
				props_tDBOutput_1.table.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:bHEJMJIkO2ZO7NKC+4v2IXT2RAgFaOM959J1kstQc4npbbHveWZ6i8uCtw=="));
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"SALE\",\"fields\":[{", s);

						a("\"name\":\"SALE_ID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"SALE_ID\",\"talend.field.dbColumnName\":\"SALE_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"SALE_ID\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"DATE_SALE\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"},\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DATE_SALE\",\"talend.field.dbColumnName\":\"DATE_SALE\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"yyyy-MM-dd'T'HH:mm:ss\",\"di.column.relationshipType\":\"\",\"di.prop.di.column.logicalType\":\"timestamp-millis\",\"di.table.label\":\"DATE_SALE\",\"di.prop.di.date.timestamp\":\"true\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"CUSTOMER_ID\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CUSTOMER_ID\",\"talend.field.dbColumnName\":\"CUSTOMER_ID\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CUSTOMER_ID\",\"di.column.relatedEntity\":\"\"}],\"di.table.comment\":\"\",\"di.table.name\":\"SALE\",\"di.table.label\":\"SALE\"}",
								s);
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append(
									"FILENAME" + " = " + "\"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SALE.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
							...
							log4jParamters_tFileInputDelimited_1
									.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN="
											+ ("SALE_ID") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DATE_SALE")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("CUSTOMER_ID") + "}]");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SALE.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SALE.csv", "UTF-8", "|", "\n", true, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.SALE_ID = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DATE_SALE = ParserUtils.parseTo_Date(temp, "yyyy-MM-dd'T'HH:mm:ss");
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"DATE_SALE", "row1", temp, ex_tFileInputDelimited_1),
...
///////////////////////		
							...
							if (row1.SALE_ID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.SALE_ID));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.DATE_SALE != null) { //

								strBuffer_tLogRow_1
										.append(FormatterUtils.format_Date(row1.DATE_SALE, "yyyy-MM-dd'T'HH:mm:ss"));
...
///////////////////////    			
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "SALE",
									"tSnowflakeOutput"
							...
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("SALE_ID") != null) {
								incomingEnforcer_tDBOutput_1.put("SALE_ID", row2.SALE_ID);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null
									&& incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("DATE_SALE") != null) {
								incomingEnforcer_tDBOutput_1.put("DATE_SALE", row2.DATE_SALE);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
					...
					if (!((Object) ("C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_SALE.csv") instanceof java.io.InputStream)) {
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "SALE", "tSnowflakeOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
	...
	public static void main(String[] args) {
		final jReadFileSaleTD jReadFileSaleTDClass = new jReadFileSaleTD();

		int exitCode = jReadFileSaleTDClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'jReadFileSaleTD' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'jReadFileSaleTD' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_fq5VUKN5EfCCd7k3d2fHCg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-10-07T13:00:03.831401500Z");
		...
		try {
			...
			java.io.InputStream inContext = jReadFileSaleTD.class.getClassLoader()
					.getResourceAsStream("edd_tp1/jreadfilesaletd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jReadFileSaleTD.class.getClassLoader()
		...
		log.info("TalendJob: 'jReadFileSaleTD' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : jReadFileSaleTD");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'jReadFileSaleTD' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 114424 characters generated by Talend Cloud API Services Platform on the 7
 * octobre 2025 à 15:00:03 CEST
 ************************************************************************************************/