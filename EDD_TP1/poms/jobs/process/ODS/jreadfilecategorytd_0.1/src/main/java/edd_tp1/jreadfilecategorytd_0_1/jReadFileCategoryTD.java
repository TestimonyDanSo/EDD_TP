...
package edd_tp1.jreadfilecategorytd_0_1;
...
/**
 * Job: jReadFileCategoryTD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jReadFileCategoryTD implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "jReadFileCategoryTD.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(jReadFileCategoryTD.class);
	...
	private final String jobName = "jReadFileCategoryTD";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				jReadFileCategoryTD.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jReadFileCategoryTD.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_EDD_TP1_jReadFileCategoryTD = new byte[0];
		static byte[] commonByteArray_EDD_TP1_jReadFileCategoryTD = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EDD_TP1_jReadFileCategoryTD.length) {
					if (length < 1024 && commonByteArray_EDD_TP1_jReadFileCategoryTD.length == 0) {
						commonByteArray_EDD_TP1_jReadFileCategoryTD = new byte[1024];
					} else {
						commonByteArray_EDD_TP1_jReadFileCategoryTD = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EDD_TP1_jReadFileCategoryTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileCategoryTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EDD_TP1_jReadFileCategoryTD, 0, length);
				strReturn = new String(commonByteArray_EDD_TP1_jReadFileCategoryTD, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EDD_TP1_jReadFileCategoryTD) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		mdc("tFileInputDelimited_1", "IKbutN_");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBOutput_1", "CATEGORY_PRODUCT", "tSnowflakeOutput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				props_tDBOutput_1.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:NR7/XH29bjgdA6CZ5S6yA4/uxNCf9T9N8Zl4hBlqBDO/p588dcPcMr7WqA=="));

				props_tDBOutput_1.connection.referencedComponent.setValue("referenceDefinitionName",
						"tSnowflakeConnection");

				props_tDBOutput_1.table.setValue("tableName", "CATEGORY_PRODUCT");
				...
				props_tDBOutput_1.table.connection.userPassword.setValue("password",
						routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:zskn2FO/e+QGwFaGHYsdm69VF9ud7PTRYwcJp5woOslFN3TPa05lDQJReQ=="));
				...
				class SchemaSettingTool_tDBOutput_1_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"CATEGORY_PRODUCT\",\"fields\":[{", s);

						a("\"name\":\"CODE_CATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"CODE_CATEGORY\",\"talend.field.dbColumnName\":\"CODE_CATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"50\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"CODE_CATEGORY\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"DESCRIPTION_CATEGORY\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"DESCRIPTION_CATEGORY\",\"talend.field.dbColumnName\":\"DESCRIPTION_CATEGORY\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"100\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"DESCRIPTION_CATEGORY\",\"di.column.relatedEntity\":\"\"}],\"di.table.comment\":\"\",\"di.table.name\":\"CATEGORY_PRODUCT\",\"di.table.label\":\"CATEGORY_PRODUCT\"}",
								s);
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append(
									"FILENAME" + " = " + "\"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CATEGORY.csv\"");
							log4jParamters_tFileInputDelimited_1.append(" | ");
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CATEGORY.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CATEGORY.csv", "UTF-8", "|", "\n", true, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.DESCRIPTION_CATEGORY = fid_tFileInputDelimited_1
...
///////////////////////		
							...
							if (row1.CODE_CATEGORY != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.CODE_CATEGORY));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.DESCRIPTION_CATEGORY != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.DESCRIPTION_CATEGORY));
...
///////////////////////    			
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row2", "tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "CATEGORY_PRODUCT",
									"tSnowflakeOutput"
							...
							if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema()
									.getField("CODE_CATEGORY") != null) {
								incomingEnforcer_tDBOutput_1.put("CODE_CATEGORY", row2.CODE_CATEGORY);
							}
							// skip the put action if the input column doesn't appear in component runtime
							// schema
							if (incomingEnforcer_tDBOutput_1 != null && incomingEnforcer_tDBOutput_1.getRuntimeSchema()
									.getField("DESCRIPTION_CATEGORY") != null) {
								incomingEnforcer_tDBOutput_1.put("DESCRIPTION_CATEGORY", row2.DESCRIPTION_CATEGORY);
							}
					...
					if (!((Object) ("C:/TP_ISTIC/EDD/ICOMMERCE/ICOM_20250923_CATEGORY.csv") instanceof java.io.InputStream)) {
...
// end of generic
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tDBOutput_1", "CATEGORY_PRODUCT", "tSnowflakeOutput",
						"output")) {
					talendJobLogProcess(globalMap);
				}
...
// finally of generic
	...
	public static void main(String[] args) {
		final jReadFileCategoryTD jReadFileCategoryTDClass = new jReadFileCategoryTD();

		int exitCode = jReadFileCategoryTDClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'jReadFileCategoryTD' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'jReadFileCategoryTD' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_6EDUAKNxEfCCd7k3d2fHCg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-10-07T11:55:06.430881Z");
		...
		try {
			...
			java.io.InputStream inContext = jReadFileCategoryTD.class.getClassLoader()
					.getResourceAsStream("edd_tp1/jreadfilecategorytd_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jReadFileCategoryTD.class.getClassLoader()
		...
		log.info("TalendJob: 'jReadFileCategoryTD' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : jReadFileCategoryTD");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'jReadFileCategoryTD' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 108523 characters generated by Talend Cloud API Services Platform on the 7
 * octobre 2025 à 13:55:06 CEST
 ************************************************************************************************/